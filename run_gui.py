...
from lifeguard.system.state import MsgMOBActivated
...
if __name__ == "__main__":
    ...
    # Bridge for backend threads to post messages into the GUI queue
    ...
    def on_mob_press():
        """Inject a MOB activation event into the MAVLink worker."""
        logging.info("MOB button pressed by operator.")
        lifeguard_backend.mav.inbox.put(MsgMOBActivated())
